...
However, flipping the sign of a state vector $\vect{s}$ does not alter $E$, so only half of the $2^N$ states correspond to (possibly) unique energy levels, i.e. $2^{N-1}$ unique energy levels.
